...
const sauceLabsCapabilities = {
	name: '@brightspace-ui-labs/card-overlay unit tests',
	// eslint-disable-next-line no-undef
	build: `@brightspace-ui-labs/card-overlay ${process.env.GITHUB_REF ?? 'local'} build ${process.env.GITHUB_RUN_NUMBER ?? ''}`
};
